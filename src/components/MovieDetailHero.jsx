...
export default function MovieDetailHero({ movie, trailerKey }) {
  const backdrop = getTmdbBackdropUrl(movie.backdrop_path) || getTmdbImageUrl(movie.poster_path);
    ...
    <header className="relative mb-8">
      ...
      <div className="container relative z-20 mx-auto -mt-28 px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_420px]">
          ...
          <aside className="space-y-4 text-center lg:text-right">
            <div className="flex justify-center lg:justify-end">
              <MovieDetailRating rating={movie.vote_average} label="tmdb" />
            </div>

            {trailerKey ? (
              <div className="mx-auto max-w-md overflow-hidden rounded-lg border border-white/10 lg:mx-0 lg:max-w-none">
                <iframe
